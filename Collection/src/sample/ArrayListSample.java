...
public class ArrayListSample {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1番目の要素を取得（置換前）:" + places.get(0));
        
        //要素の変更
        places.set(0, "スウェーデン");//最初の要素を置換
        System.out.println("1番目の要素（置換後）:" + places.get(1));
        
        //要素の削除
        System.out.println("1番目の要素（削除前）:" + places.get(1));
        places.remove(1);
        System.out.println("1番目の要素（削除後）:" + places.get(1));
